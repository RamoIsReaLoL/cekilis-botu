...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        .setTimestamp()
        .setFooter(`Requested by ${interaction.user.username} Giveaway`, interaction.user.displayAvatarURL());
          ...
          .setTimestamp()
          .setFooter(` ${interaction.user.username} Giveaway`, interaction.user.displayAvatarURL());
