...
.addField(`Links:`,`- [Website](https://giveawaybot.gq/)\n- [Social Media](https://orbon.ml/RamoIsReaLoL)\n- [Discord Server](https://discord.gg/swPg7ADmP4)`,true)
.setTimestamp()
.setFooter(`Requested by ${message.author.username} Giveavay`, message.author.displayAvatarURL());

  const giveaway = new MessageEmbed()
  .setTitle("Giveavay Help")
  .setColor('#2F3136')
  ...
  .setTimestamp()
  .setFooter(`Requested by ${message.author.username} Giveaway`, message.author.displayAvatarURL());
